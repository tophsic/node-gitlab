(function() {
  ...
  ProjectRepository = (function(superClass) {
    ...
    ProjectRepository.prototype.compare = function(projectId, from, to, fn) {
      var params;
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::compare()");
      params = {
        from: from,
        to: to
      };
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/repository/compare/", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
